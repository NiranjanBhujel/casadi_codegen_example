 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Oct 25 09:44:46 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                test_sfun
...
#define SOURCEFILES                    "__SFB__test_example.c"
...
extern void test_sfun_Outputs_wrapper(const real_T *x,
  const real_T *y,
  real_T *f1,
  real_T *f2);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  real_T *f1 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *f2 = (real_T *) ssGetOutputPortRealSignal(S, 1);
  test_sfun_Outputs_wrapper(x, y, f1, f2);
}
